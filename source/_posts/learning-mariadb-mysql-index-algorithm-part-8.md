...
![btree-01](https://www.zhuxiaodong.net/static/images/btree-01.png)
...
![btree-02](https://www.zhuxiaodong.net/static/images/btree-02.png)
...
![btree-03](https://www.zhuxiaodong.net/static/images/btree-03.png)

上图中，当需要插入一个新的键值为9的节点时，需要将7这个节点左旋来保证平衡。

再来看一个更复杂的例子：

![btree-04](https://www.zhuxiaodong.net/static/images/btree-04.png)
...
![b+tree-01](https://www.zhuxiaodong.net/static/images/b+tree-01.png)
...
![b+tree-02](https://www.zhuxiaodong.net/static/images/b+tree-02.png)

接着再插入 70 这个键值，这时原先的 Leaf Page 已经满了，但是 Index Page 还没有满，因此插入 Leaf Page 后的情况为 50、55、60、65、70，并根据中间的值60来拆分叶子节点。

![b+tree-03](https://www.zhuxiaodong.net/static/images/b+tree-03.png)

最后插入键值95，即 Leaf Page 和 Index Page 都满了，这时需要做一次 Leaf Page 的拆分和一次 Index Page 的拆分。

![b+tree-04](https://www.zhuxiaodong.net/static/images/b+tree-04.png)
...
![b+tree-05](https://www.zhuxiaodong.net/static/images/b+tree-05.png)
...
![b+tree-06](https://www.zhuxiaodong.net/static/images/b+tree-06.png)

接着删除键值为25的记录，它也符合上表讨论的第一种情况，只不过由于25在 Index Page 中，因此还需要用它的右节点 28 来做一次更新。

![b+tree-07](https://www.zhuxiaodong.net/static/images/b+tree-07.png)

最后看删除键值为60的情况。由于 Leaf Page 删除了60之后， Fill Factor 小于 50%，这是需要做合并操作，此外，Index Page 中 也存在 60 的记录，也需要做合并操作。

![b+tree-08](https://www.zhuxiaodong.net/static/images/b+tree-08.png)
...
![cluster-index-structure](https://www.zhuxiaodong.net/static/images/cluster-index-structure.png)
...
![secondary-index-structure](https://www.zhuxiaodong.net/static/images/secondary-index-structure.png)
...
![union-index](https://www.zhuxiaodong.net/static/images/union-index.png)
...
![directly-address-table](https://www.zhuxiaodong.net/static/images/directly-address-table.png)
...
![hash-table](https://www.zhuxiaodong.net/static/images/hash-table.png)
...
![hash-table-chaining](https://www.zhuxiaodong.net/static/images/hash-table-chaining.png)
